...
const ProjectCard = ({ post, index }: { post: PostI; index: number }) => {
    ...
    return (
        <div className="h-full flex flex-col">
            ...
            <motion.article
                className="relative p-6 rounded-xl overflow-hidden group hover:-translate-y-2 transition-transform duration-500 glass-etch backdrop-blur-4xl    bg-accent group-hover:bg-white/5 group-hover:border-white/20 flex-1"
                key={post.slug}
                // initial="offscreen"
                whileInView={{
                    opacity: 1,
